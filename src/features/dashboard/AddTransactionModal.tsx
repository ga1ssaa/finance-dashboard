                ...
                {/* 4. Cateories */}
                    ...
                    <div className="flex gap-3 pt-2">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 px-4 py-2 border border-slate-200 rounded-lg bg-slate-100 hover:bg-slate-200 cursor-pointer transition-colors font-medium font-serif"
                        >
                            Cancel
                        </button>
                        <button
                            type="submit"
                            className="flex-1 px-4 py-2 border border-slate-200 rounded-lg bg-blue-500 hover:bg-blue-600 cursor-pointer transition-colors font-medium font-serif"
                        >
                            Add
                        </button>
                    </div>
